...
int libantplus_ResetSystem ()
{
	...
	msg[0] = MESG_TX_SYNC;			// sync byte
	msg[1] = 1;						// length
	msg[2] = MESG_SYSTEM_RESET_ID;	
	msg[3] = 0;						// nop
